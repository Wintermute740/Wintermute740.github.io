# SMTP PHPMailer - phpBB2 MOD

This is a simple mod that wraps onto the PHPMailer classes to send SMTP emails from the phpBB2 board admin. It means that the ancient phpBB2 can connect to modern email servers that require TLS authentication.

Read `phpbb2_smtp_phpmailer.mod` for installation instructions.

This is an updated version of the [BetterSMTP MOD](https://github.com/konsulting/phpBB2-BetterSMTP) that used [SquirrelMail](https://sourceforge.net/projects/squirrelmail/).
