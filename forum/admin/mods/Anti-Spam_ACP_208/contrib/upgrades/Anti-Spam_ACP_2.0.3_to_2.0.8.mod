##############################################################
## MOD Title: Anti-spam ACP 2.0.3 to 2.0.8 upgrade
...
## Installation Time:	~7 min (less than 1 min with EasyMOD)
##
...
If you do NOT have Anti-spam ACP 2.0.3 installed DO NOT install this .mod file!
