##############################################################
## MOD Title: Anti-spam ACP 2.0.0 to 2.0.8 upgrade
...
## Installation Time:	~9 min (less than 1 min with EasyMOD)
##
...
If you do NOT have Anti-spam ACP 2.0.0 installed DO NOT install this .mod file!
