##############################################################
## MOD Title: Anti-spam ACP 2.0.0a to 2.0.8 upgrade
...
## Installation Time:	~11 min (less than 1 min with EasyMOD)
##
...
If you do NOT have Anti-spam ACP 2.0.0a installed DO NOT install this .mod file!
