##############################################################
## MOD Title: Anti-spam ACP 2.0.6 to 2.0.8 upgrade
...
## Installation Time:	~2 min (less than 1 min with EasyMOD)
##
...
If you do NOT have Anti-spam ACP 2.0.6 installed DO NOT install this .mod file!
