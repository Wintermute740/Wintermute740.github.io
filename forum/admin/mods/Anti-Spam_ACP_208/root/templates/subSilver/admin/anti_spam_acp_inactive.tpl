...
{ 
  ...
  { 
    allAre = 1; 
    other_pic.innerHTML = "<img src='../templates/subSilver/images/arrowdown.png'>"; 
  } 
  else 
  { 
    allAre = 0; 
    other_pic.innerHTML = "<img src='../templates/subSilver/images/arrowright.png'>"; 
  } 
...
{ 
  ...
  { 
    ...
    { 
      obj.style.display = ""; 
      pic_obj.innerHTML = "<img src='../templates/subSilver/images/arrowdown.png'>"; 
    } 
    else 
    { 
      obj.style.display = "none"; 
      pic_obj.innerHTML = "<img src='../templates/subSilver/images/arrowright.png'>"; 
    } 
  } 
  else 
  { 
...
<h1>{L_INACTIVE_USERLIST} <span class="genmed">{L_INACTIVE_USERLIST_CREATED_BY}; {L_INACTIVE_USERLIST_MODIFIED_BY}</span></h1>
...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
	<tr>
	    ...
	    <th width="2%" onClick="javascript:openAll();" id="top_folder"><img src='../templates/subSilver/images/arrowright.png'></th>
	...
	<tr>
		...
		<td class="{user_row.ROW_CLASS}" nowrap="nowrap"><span id="oI[]" onClick="javascript:handleClick('{user_row.USER_ID}');"><div id="{user_row.USER_ID}" name="oF[]"><img src='../templates/subSilver/images/arrowright.png'></div></span></td>		<td class="{user_row.ROW_CLASS}"><span class="gen" {user_row.STYLE_COLOR}><b><a href="{user_row.U_MANAGE}" class="gen" {user_row.STYLE_COLOR}>{user_row.USERNAME}</a></b></span></td>
	...
	<tr>
		<td class="catbottom" colspan="9">
			<select name="mode" class="post">
				...
				<option value="activate">{L_ACTIVATE}</option>
			</select>
